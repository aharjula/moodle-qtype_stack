...
class qtype_stack_walkthrough_state_test extends qtype_stack_walkthrough_test_base {
    ...
    public function test_state_test_initialisation_and_correct_scene_progression() {
        ...
        $this->process_submission(array('ans1' => '4', '-submit' => 1, qtype_stack_question::SEQN_NAME => 1));
        ...
        $this->process_submission(array('ans1' => '4', 'ans1_val' => '4', '-submit' => 1, qtype_stack_question::SEQN_NAME => 2));
        ...
        $this->process_submission(array('ans2' => '5', 'ans2_val' => '5', '-submit' => 1, qtype_stack_question::SEQN_NAME => 3));
        ...
        $this->process_submission(array('ans3' => '-2', 'ans3_val' => '-2', '-submit' => 1, qtype_stack_question::SEQN_NAME => 4));
    ...
    public function test_state_test_initialisation_and_incorrect_answers() {
        ...
        // Process a submit of the correct answer. To initiate scene transition.
        $this->process_submission(array('ans1' => '5', 'ans1_val' => '5', '-submit' => 1, qtype_stack_question::SEQN_NAME => 1));
        ...
        $this->process_submission(array('ans2' => '5', 'ans2_val' => '5', '-submit' => 1, qtype_stack_question::SEQN_NAME => 2));
