...
$string['referencesundefinedstatevariable'] = 'References state-variable <code>{$a->key}</code> of <code>{$a->context}</code>-scope, without declaring it in the variable definitions field.';
...
$string['variabledefinitions'] = 'Variable-definitions';
$string['variabledefinitions_help'] = 'This field allows the definition of state-variables as well as references to outside values like the name of the user. It also allows you to define texput commands that apply in the whole question and declarations e.g. constants.';
$string['quiet'] = 'Quiet';
...
$string['replacedollarsnoproblems'] = 'No delimiters found which can be fixed.';
...
$string['healthcheckjsxgraph'] = 'Check if JSXGraph is installed.';
$string['healthcheckjsxgraphfound'] = 'The JSXGraph filter is installed and is active.';
$string['healthcheckjsxgraphfoundinactive'] = 'The JSXGraph filter is installed but it is not active.  To use the JSXGraph filter you need to switch it on from the admin settings, and make sure it is available in any course/context where it is needed.';
$string['healthcheckjsxgraphmissing'] = 'The JSXGraph filter is missing.  If you would like to make use of JSXGraph you need to install the filter.';
